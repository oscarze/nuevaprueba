    ...
    <main>
        <section class="contenedor info-pagina">
            ...
            <div class="contenedor-info-pagina">
                <img src="img/ilus2.svg" alt="" class="imagen-info-pag">
        ...
        <h2 class="titulo">Total Look X este ¡2021!</h2>
        ...
        <section class="clientes contenedor">
            ...
            <div class="cards">
                <div class="card">
                    <img src="img/chat.svg" alt="imagen de chat de contacto">
                ...
                <div class="card">
                    <img src="img/llamada.svg" alt="imagen de telefono de contacto">
                    <div class="contenido-texto-card">
                        <h4>800 457 004</h4>
            ...
            <div class="contenedor">
                ...
                <div class="servicio-cont">
                    <div class="servicio-ind">
                        ...
                        <h3>ACERCA DE LA SITUACIÓN ACTUAL</h3>
                        <p>INFORMACIÓN SOBRE EL ESTADO DE NUESTRAS TIENDAS Y DEVOLUCIONES. </p>
                    </div>
                    <div class="servicio-ind">
                        <img src="img/ilustracion4.svg" alt="">
                        <h3>Ropa de moda para hombre</h3>
                        <p>Crea tu look con las prendas esenciales de primavera verano 2021 y 
                            encuentra playeras, sudaderas, jeans, pantalones o zapatos para chico 
                            de estilo casual y con un toque moderno. Ropa y zapatos imprescindibles 
                            y a la última para que vistas tal y como eres.</p>
                    </div>
                    <div class="servicio-ind">
